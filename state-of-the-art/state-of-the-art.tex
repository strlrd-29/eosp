...
Machine learning (ML) is a specialized field within artificial intelligence (AI) dedicated to the development and analysis of statistical algorithms capable of learning from data and making predictions without explicit programming. In recent years, artificial neural networks (ANNs) have emerged as particularly powerful tools, showcasing superior performance compared to traditional methods. ML boasts a wide range of applications spanning various domains, including natural language processing, computer vision, speech recognition, email filtering, agriculture, and medicine. In business contexts, ML is commonly known as predictive analytics. While not all ML methods rely on statistical principles, computational statistics significantly influences the methodologies employed in the field \cite{enwiki:1220758567}.
...
Deep learning encompasses machine learning techniques that utilize artificial neural networks (ANNs) with representation learning. The term "deep" denotes the use of multiple layers within the network architecture. These methods can be supervised, semi-supervised, or unsupervised, depending on the learning approach employed.

Architectures such as deep neural networks, deep belief networks, recurrent neural networks, convolutional neural networks, and transformers are prominent examples of deep learning models. These models have found applications in diverse fields, including computer vision, speech recognition, natural language processing, machine translation, bioinformatics, drug design, medical image analysis, climate science, material inspection, and board game programs. In many cases, deep learning approaches have achieved results comparable to, and sometimes surpassing, human expert performance \cite{enwiki:1220437155}.
